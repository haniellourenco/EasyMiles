...
from datetime import timedelta # Adicionado para Simple JWT
...
DATABASES = {
    'default': {
        ...
        'HOST': config('DB_HOST'),
        'PORT': config('DB_PORT', default='8912'),
    }
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticated', # Bloqueia acesso não autenticado por padrão
    ),
}
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',), # Define o prefixo do token no header (Bearer <token>)
